	...
	<div class="standard" id="standardID">
		<!-- 폼 이름 정해주기 -->
			...
			<div id="sub_name"  class="subject">
				...
				<div class="subject"><input type="button" value="변경" name="modify" onclick="sub_name_modify('standardID')"></div>
			</div>	
			<!-- 변경을 누르면 나타나는 입력 폼 -->
		...
		<!-- 내용 입력하는 곳 -->
		<div> <textarea name="contents[]" rows="17" cols="100%"></textarea> </div>
		<div> <input type="button" value="추가" onclick="add_introduce()"> </div>
	</div>
